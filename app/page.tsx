  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <div className="max-w-3xl mx-auto px-6 py-12 md:py-16">
        ...
        {/* Page title */}
        <h1 className="font-dancing text-5xl md:text-6xl text-[#00BCD4] mb-10 leading-tight">
          NLP MetaFest
        </h1>
        ...
        {/* Section heading */}
        <h2 className="font-dancing text-3xl md:text-4xl text-[#00BCD4] mb-7 leading-snug">
